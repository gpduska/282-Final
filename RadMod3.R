...
genetic.algorithm.3 <- function(population){
  ...
  loss.cutoff <- median(population[,7]) + 1
...
run.n.gens.3 <- function(n, population){
  ...
  median.num.losses <- c()
  seventy.fifth.quantile.num.losses <- c()
  twenty.fifth.quantile.num.losses <- c()
  ...
  agent.1.init.power <- c()
  agent.2.init.power <- c()
  agent.3.init.power <- c()
  agent.4.init.power <- c()
  agent.5.init.power <- c()
  agent.6.init.power <- c()
  agent.7.init.power <- c()
  agent.8.init.power <- c()
  agent.9.init.power <- c()
  agent.10.init.power <- c()
  agent.11.init.power <- c()
  agent.12.init.power <- c()
  agent.13.init.power <- c()
  agent.14.init.power <- c()
  agent.15.init.power <- c()
  agent.16.init.power <- c()
  agent.17.init.power <- c()
  agent.18.init.power <- c()
  agent.19.init.power <- c()
  agent.20.init.power <- c()
  agent.21.init.power <- c()
  agent.22.init.power <- c()
  agent.23.init.power <- c()
  agent.24.init.power <- c()
  agent.25.init.power <- c()
  agent.26.init.power <- c()
  agent.27.init.power <- c()
  agent.28.init.power <- c()
  agent.29.init.power <- c()
  agent.30.init.power <- c()
  ...
  agent.8.end.power <- c()
  agent.9.end.power <- c()
  agent.10.end.power <- c()
  agent.11.end.power <- c()
  agent.12.end.power <- c()
  agent.13.end.power <- c()
  agent.14.end.power <- c()
  agent.15.end.power <- c()
  agent.16.end.power <- c()
  agent.17.end.power <- c()
  agent.18.end.power <- c()
  agent.19.end.power <- c()
  agent.20.end.power <- c()
  agent.21.end.power <- c()
  agent.22.end.power <- c()
  agent.23.end.power <- c()
  agent.24.end.power <- c()
  agent.25.end.power <- c()
  agent.26.end.power <- c()
  agent.27.end.power <- c()
  agent.28.end.power <- c()
  agent.29.end.power <- c()
  agent.30.end.power <- c()
  ...
  for(i in 1:n){
    ...
    seventy.fifth.quantile.num.losses <- append(seventy.fifth.quantile.num.losses, quantile(population[,7], .75), after = length(seventy.fifth.quantile.num.losses))
    twenty.fifth.quantile.num.losses <- append(twenty.fifth.quantile.num.losses, quantile(population[,7], .25), after = length(twenty.fifth.quantile.num.losses))
    ...
    agent.1.init.power <- append(agent.1.init.power, population[1,5], after = length(agent.1.init.power))
    agent.2.init.power <- append(agent.2.init.power, population[2,5], after = length(agent.2.init.power))
    agent.3.init.power <- append(agent.3.init.power, population[3,5], after = length(agent.3.init.power))
    agent.4.init.power <- append(agent.4.init.power, population[4,5], after = length(agent.4.init.power))
    agent.5.init.power <- append(agent.5.init.power, population[5,5], after = length(agent.5.init.power))
    agent.6.init.power <- append(agent.6.init.power, population[6,5], after = length(agent.6.init.power))
    agent.7.init.power <- append(agent.7.init.power, population[7,5], after = length(agent.7.init.power))
    agent.8.init.power <- append(agent.8.init.power, population[8,5], after = length(agent.8.init.power))
    agent.9.init.power <- append(agent.9.init.power, population[9,5], after = length(agent.9.init.power))
    agent.10.init.power <- append(agent.10.init.power, population[10,5], after = length(agent.10.init.power))
    agent.11.init.power <- append(agent.11.init.power, population[11,5], after = length(agent.11.init.power))
    agent.12.init.power <- append(agent.12.init.power, population[12,5], after = length(agent.12.init.power))
    agent.13.init.power <- append(agent.13.init.power, population[13,5], after = length(agent.13.init.power))
    agent.14.init.power <- append(agent.14.init.power, population[14,5], after = length(agent.14.init.power))
    agent.15.init.power <- append(agent.15.init.power, population[15,5], after = length(agent.15.init.power))
    agent.16.init.power <- append(agent.16.init.power, population[16,5], after = length(agent.16.init.power))
    agent.17.init.power <- append(agent.17.init.power, population[17,5], after = length(agent.17.init.power))
    agent.18.init.power <- append(agent.18.init.power, population[18,5], after = length(agent.18.init.power))
    agent.19.init.power <- append(agent.19.init.power, population[19,5], after = length(agent.19.init.power))
    agent.20.init.power <- append(agent.20.init.power, population[20,5], after = length(agent.20.init.power))
    agent.21.init.power <- append(agent.21.init.power, population[21,5], after = length(agent.21.init.power))
    agent.22.init.power <- append(agent.22.init.power, population[22,5], after = length(agent.22.init.power))
    agent.23.init.power <- append(agent.23.init.power, population[23,5], after = length(agent.23.init.power))
    agent.24.init.power <- append(agent.24.init.power, population[24,5], after = length(agent.24.init.power))
    agent.25.init.power <- append(agent.25.init.power, population[25,5], after = length(agent.25.init.power))
    agent.26.init.power <- append(agent.26.init.power, population[26,5], after = length(agent.26.init.power))
    agent.27.init.power <- append(agent.27.init.power, population[27,5], after = length(agent.27.init.power))
    agent.28.init.power <- append(agent.28.init.power, population[28,5], after = length(agent.28.init.power))
    agent.29.init.power <- append(agent.29.init.power, population[29,5], after = length(agent.29.init.power))
    agent.30.init.power <- append(agent.30.init.power, population[30,5], after = length(agent.30.init.power))
    
    
    
    agent.1.end.power <- append(agent.1.end.power, population[1,6], after = length(agent.1.end.power))
    agent.2.end.power <- append(agent.2.end.power, population[2,6], after = length(agent.2.end.power))
    agent.3.end.power <- append(agent.3.end.power, population[3,6], after = length(agent.3.end.power))
    agent.4.end.power <- append(agent.4.end.power, population[4,6], after = length(agent.4.end.power))
    agent.5.end.power <- append(agent.5.end.power, population[5,6], after = length(agent.5.end.power))
    agent.6.end.power <- append(agent.6.end.power, population[6,6], after = length(agent.6.end.power))
    agent.7.end.power <- append(agent.7.end.power, population[7,6], after = length(agent.7.end.power))
    agent.8.end.power <- append(agent.8.end.power, population[8,6], after = length(agent.8.end.power))
    agent.9.end.power <- append(agent.9.end.power, population[9,6], after = length(agent.9.end.power))
    agent.10.end.power <- append(agent.10.end.power, population[10,6], after = length(agent.10.end.power))
    agent.11.end.power <- append(agent.11.end.power, population[11,6], after = length(agent.11.end.power))
    agent.12.end.power <- append(agent.12.end.power, population[12,6], after = length(agent.12.end.power))
    agent.13.end.power <- append(agent.13.end.power, population[13,6], after = length(agent.13.end.power))
    agent.14.end.power <- append(agent.14.end.power, population[14,6], after = length(agent.14.end.power))
    agent.15.end.power <- append(agent.15.end.power, population[15,6], after = length(agent.15.end.power))
    agent.16.end.power <- append(agent.16.end.power, population[16,6], after = length(agent.16.end.power))
    agent.17.end.power <- append(agent.17.end.power, population[17,6], after = length(agent.17.end.power))
    agent.18.end.power <- append(agent.18.end.power, population[18,6], after = length(agent.18.end.power))
    agent.19.end.power <- append(agent.19.end.power, population[19,6], after = length(agent.19.end.power))
    agent.20.end.power <- append(agent.20.end.power, population[20,6], after = length(agent.20.end.power))
    agent.21.end.power <- append(agent.21.end.power, population[21,6], after = length(agent.21.end.power))
    agent.22.end.power <- append(agent.22.end.power, population[22,6], after = length(agent.22.end.power))
    agent.23.end.power <- append(agent.23.end.power, population[23,6], after = length(agent.23.end.power))
    agent.24.end.power <- append(agent.24.end.power, population[24,6], after = length(agent.24.end.power))
    agent.25.end.power <- append(agent.25.end.power, population[25,6], after = length(agent.25.end.power))
    agent.26.end.power <- append(agent.26.end.power, population[26,6], after = length(agent.26.end.power))
    agent.27.end.power <- append(agent.27.end.power, population[27,6], after = length(agent.27.end.power))
    agent.28.end.power <- append(agent.28.end.power, population[28,6], after = length(agent.28.end.power))
    agent.29.end.power <- append(agent.29.end.power, population[29,6], after = length(agent.29.end.power))
    agent.30.end.power <- append(agent.30.end.power, population[30,6], after = length(agent.30.end.power))
  ...
  return(list(a = population, b = average.encounter.slope, c = average.encounter.intercept, d = average.take.attempt.slope, 
              ...
              j = matrix(c(agent.1.take.attempt.intercept, agent.2.take.attempt.intercept, agent.3.take.attempt.intercept, agent.4.take.attempt.intercept, agent.5.take.attempt.intercept,
                         ...
                         byrow = TRUE, nrow = 30),
              k = matrix(c(agent.1.init.power, agent.2.init.power, agent.3.init.power, agent.4.init.power, agent.5.init.power,
                          agent.6.init.power, agent.7.init.power, agent.8.init.power, agent.9.init.power, agent.10.init.power,
                          agent.11.init.power, agent.12.init.power, agent.13.init.power, agent.14.init.power, agent.15.init.power,
                          agent.16.init.power, agent.17.init.power, agent.18.init.power, agent.19.init.power, agent.20.init.power,
                          agent.21.init.power, agent.22.init.power, agent.23.init.power, agent.24.init.power, agent.25.init.power,
                          agent.26.init.power, agent.27.init.power, agent.28.init.power, agent.29.init.power, agent.30.init.power),
                        byrow = TRUE, nrow = 30),
              l = matrix(c(agent.1.end.power, agent.2.end.power, agent.3.end.power, agent.4.end.power, agent.5.end.power,
                           agent.6.end.power, agent.7.end.power, agent.8.end.power, agent.9.end.power, agent.10.end.power,
                           agent.11.end.power, agent.12.end.power, agent.13.end.power, agent.14.end.power, agent.15.end.power,
                           agent.16.end.power, agent.17.end.power, agent.18.end.power, agent.19.end.power, agent.20.end.power,
                           agent.21.end.power, agent.22.end.power, agent.23.end.power, agent.24.end.power, agent.25.end.power,
                           agent.26.end.power, agent.27.end.power, agent.28.end.power, agent.29.end.power, agent.30.end.power),
                         byrow = TRUE, nrow = 30),
              m = matrix(c(agent.1.num.losses, agent.2.num.losses, agent.3.num.losses, agent.4.num.losses, agent.5.num.losses,
                         ...
                         byrow = TRUE, nrow = 30),
              n = seventy.fifth.quantile.num.losses, o = twenty.fifth.quantile.num.losses))
}
...
results <- run.n.gens.3(1000, population)
...
init.power.matrix <- results$k
end.power.matrix <- results$l
num.losses.matrix <- results$m
seventy.fifth.num.losses <- results$n
twenty.fifth.num.losses <- results$o


plot(1:1000, average.encounter.slope, xlab = "Selection Number", ylab = "M1" , main = "Average M1 After Selection Process")
plot(1:1000, average.encounter.intercept, xlab = "Selection Number", ylab = "B1" , main = "Average B1 After Selection Process")
plot(1:1000, average.take.attempt.slope, xlab = "Selection Number", ylab = "M2" , main = "Average M2 After Selection Process")
plot(1:1000, average.take.attempt.intercept, xlab = "Selection Number", ylab = "B2" , main = "Average B2 After Selection Process")
...
plot(1:1000, encounter.slope.matrix[1,], xlab = "Selection Number", ylab = "M1" , main = "Agent 1 M1 After Selection Process")
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[2,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[3,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[4,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[5,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[6,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[7,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[8,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[9,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[10,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[11,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[12,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[13,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[14,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[15,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[16,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[17,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[18,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[19,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[20,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[21,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[22,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[23,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[24,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[25,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[26,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[27,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[28,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[29,])
par(new = TRUE)
plot(1:1000, encounter.slope.matrix[30,])
par(new = TRUE)

plot(1:1000, encounter.intercept.matrix[1,], xlab = "Selection Number", ylab = "B1" , main = "Agent 1 B1 After Selection Process")
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[2,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[3,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[4,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[5,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[6,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[7,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[8,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[9,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[10,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[11,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[12,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[13,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[14,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[15,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[16,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[17,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[18,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[19,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[20,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[21,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[22,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[23,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[24,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[25,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[26,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[27,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[28,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[29,])
par(new = TRUE)
plot(1:1000, encounter.intercept.matrix[30,])

plot(1:1000, take.attempt.slope.matrix[1,], xlab = "Selection Number", ylab = "M2" , main = "Agent 1 M2 After Selection Process")
plot(1:1000, take.attempt.slope.matrix[2,])
plot(1:1000, take.attempt.slope.matrix[3,])
plot(1:1000, take.attempt.slope.matrix[4,])
plot(1:1000, take.attempt.slope.matrix[5,])
plot(1:1000, take.attempt.slope.matrix[6,])
plot(1:1000, take.attempt.slope.matrix[7,])
plot(1:1000, take.attempt.slope.matrix[8,])
plot(1:1000, take.attempt.slope.matrix[9,])
plot(1:1000, take.attempt.slope.matrix[10,])
plot(1:1000, take.attempt.slope.matrix[11,])
plot(1:1000, take.attempt.slope.matrix[12,])
plot(1:1000, take.attempt.slope.matrix[13,])
plot(1:1000, take.attempt.slope.matrix[14,])
plot(1:1000, take.attempt.slope.matrix[15,])
plot(1:1000, take.attempt.slope.matrix[16,])
plot(1:1000, take.attempt.slope.matrix[17,])
plot(1:1000, take.attempt.slope.matrix[18,])
plot(1:1000, take.attempt.slope.matrix[19,])
plot(1:1000, take.attempt.slope.matrix[20,])
plot(1:1000, take.attempt.slope.matrix[21,])
plot(1:1000, take.attempt.slope.matrix[22,])
plot(1:1000, take.attempt.slope.matrix[23,])
plot(1:1000, take.attempt.slope.matrix[24,])
plot(1:1000, take.attempt.slope.matrix[25,])
plot(1:1000, take.attempt.slope.matrix[26,])
plot(1:1000, take.attempt.slope.matrix[27,])
plot(1:1000, take.attempt.slope.matrix[28,])
plot(1:1000, take.attempt.slope.matrix[29,])
plot(1:1000, take.attempt.slope.matrix[30,])

plot(1:1000, take.attempt.intercept.matrix[1,], xlab = "Selection Number", ylab = "B2" , main = "Agent 1 B2 After Selection Process")
plot(1:1000, take.attempt.intercept.matrix[2,])
plot(1:1000, take.attempt.intercept.matrix[3,])
plot(1:1000, take.attempt.intercept.matrix[4,])
plot(1:1000, take.attempt.intercept.matrix[5,])
plot(1:1000, take.attempt.intercept.matrix[6,])
plot(1:1000, take.attempt.intercept.matrix[7,])
plot(1:1000, take.attempt.intercept.matrix[8,])
plot(1:1000, take.attempt.intercept.matrix[9,])
plot(1:1000, take.attempt.intercept.matrix[10,])
plot(1:1000, take.attempt.intercept.matrix[11,])
plot(1:1000, take.attempt.intercept.matrix[12,])
plot(1:1000, take.attempt.intercept.matrix[13,])
plot(1:1000, take.attempt.intercept.matrix[14,])
plot(1:1000, take.attempt.intercept.matrix[15,])
plot(1:1000, take.attempt.intercept.matrix[16,])
plot(1:1000, take.attempt.intercept.matrix[17,])
plot(1:1000, take.attempt.intercept.matrix[18,])
plot(1:1000, take.attempt.intercept.matrix[19,])
plot(1:1000, take.attempt.intercept.matrix[20,])
plot(1:1000, take.attempt.intercept.matrix[21,])
plot(1:1000, take.attempt.intercept.matrix[22,])
plot(1:1000, take.attempt.intercept.matrix[23,])
plot(1:1000, take.attempt.intercept.matrix[24,])
plot(1:1000, take.attempt.intercept.matrix[25,])
plot(1:1000, take.attempt.intercept.matrix[26,])
plot(1:1000, take.attempt.intercept.matrix[27,])
plot(1:1000, take.attempt.intercept.matrix[28,])
plot(1:1000, take.attempt.intercept.matrix[29,])
plot(1:1000, take.attempt.intercept.matrix[30,])

plot(1:1000, init.power.matrix[1,])
par(new = TRUE)
plot(1:1000, init.power.matrix[2,])
par(new = TRUE)
plot(1:1000, init.power.matrix[3,])
par(new = TRUE)
plot(1:1000, init.power.matrix[4,])
par(new = TRUE)
plot(1:1000, init.power.matrix[5,])
par(new = TRUE)
plot(1:1000, init.power.matrix[6,])
par(new = TRUE)
plot(1:1000, init.power.matrix[7,])
par(new = TRUE)
plot(1:1000, init.power.matrix[8,])
par(new = TRUE)
plot(1:1000, init.power.matrix[9,])
par(new = TRUE)
plot(1:1000, init.power.matrix[10,])
par(new = TRUE)
plot(1:1000, init.power.matrix[11,])
par(new = TRUE)
plot(1:1000, init.power.matrix[12,])
par(new = TRUE)
plot(1:1000, init.power.matrix[13,])
par(new = TRUE)
plot(1:1000, init.power.matrix[14,])
par(new = TRUE)
plot(1:1000, init.power.matrix[15,])
par(new = TRUE)
plot(1:1000, init.power.matrix[16,])
par(new = TRUE)
plot(1:1000, init.power.matrix[17,])
par(new = TRUE)
plot(1:1000, init.power.matrix[18,])
par(new = TRUE)
plot(1:1000, init.power.matrix[19,])
par(new = TRUE)
plot(1:1000, init.power.matrix[20,])
par(new = TRUE)
plot(1:1000, init.power.matrix[21,])
par(new = TRUE)
plot(1:1000, init.power.matrix[22,])
par(new = TRUE)
plot(1:1000, init.power.matrix[23,])
par(new = TRUE)
plot(1:1000, init.power.matrix[24,])
par(new = TRUE)
plot(1:1000, init.power.matrix[25,])
par(new = TRUE)
plot(1:1000, init.power.matrix[26,])
par(new = TRUE)
plot(1:1000, init.power.matrix[27,])
par(new = TRUE)
plot(1:1000, init.power.matrix[28,])
par(new = TRUE)
plot(1:1000, init.power.matrix[29,])
par(new = TRUE)
plot(1:1000, init.power.matrix[30,])

plot(1:1000, end.power.matrix[1,])
par(new = TRUE)
plot(1:1000, end.power.matrix[2,])
par(new = TRUE)
plot(1:1000, end.power.matrix[3,])
par(new = TRUE)
plot(1:1000, end.power.matrix[4,])
par(new = TRUE)
plot(1:1000, end.power.matrix[5,])
par(new = TRUE)
plot(1:1000, end.power.matrix[6,])
par(new = TRUE)
plot(1:1000, end.power.matrix[7,])
par(new = TRUE)
plot(1:1000, end.power.matrix[8,])
par(new = TRUE)
plot(1:1000, end.power.matrix[9,])
par(new = TRUE)
plot(1:1000, end.power.matrix[10,])
par(new = TRUE)
plot(1:1000, end.power.matrix[11,])
par(new = TRUE)
plot(1:1000, end.power.matrix[12,])
par(new = TRUE)
plot(1:1000, end.power.matrix[13,])
par(new = TRUE)
plot(1:1000, end.power.matrix[14,])
par(new = TRUE)
plot(1:1000, end.power.matrix[15,])
par(new = TRUE)
plot(1:1000, end.power.matrix[16,])
par(new = TRUE)
plot(1:1000, end.power.matrix[17,])
par(new = TRUE)
plot(1:1000, end.power.matrix[18,])
par(new = TRUE)
plot(1:1000, end.power.matrix[19,])
par(new = TRUE)
plot(1:1000, end.power.matrix[20,])
par(new = TRUE)
plot(1:1000, end.power.matrix[21,])
par(new = TRUE)
plot(1:1000, end.power.matrix[22,])
par(new = TRUE)
plot(1:1000, end.power.matrix[23,])
par(new = TRUE)
plot(1:1000, end.power.matrix[24,])
par(new = TRUE)
plot(1:1000, end.power.matrix[25,])
par(new = TRUE)
plot(1:1000, end.power.matrix[26,])
par(new = TRUE)
plot(1:1000, end.power.matrix[27,])
par(new = TRUE)
plot(1:1000, end.power.matrix[28,])
par(new = TRUE)
plot(1:1000, end.power.matrix[29,])
par(new = TRUE)
plot(1:1000, end.power.matrix[30,])

plot(1:1000, num.losses.matrix[1,])
plot(1:1000, num.losses.matrix[2,])
plot(1:1000, num.losses.matrix[3,])
plot(1:1000, num.losses.matrix[4,])
plot(1:1000, num.losses.matrix[5,])
plot(1:1000, num.losses.matrix[6,])
plot(1:1000, num.losses.matrix[7,])
plot(1:1000, num.losses.matrix[8,])
plot(1:1000, num.losses.matrix[9,])
plot(1:1000, num.losses.matrix[10,])
plot(1:1000, num.losses.matrix[11,])
plot(1:1000, num.losses.matrix[12,])
plot(1:1000, num.losses.matrix[13,])
plot(1:1000, num.losses.matrix[14,])
plot(1:1000, num.losses.matrix[15,])
plot(1:1000, num.losses.matrix[16,])
plot(1:1000, num.losses.matrix[17,])
plot(1:1000, num.losses.matrix[18,])
plot(1:1000, num.losses.matrix[19,])
plot(1:1000, num.losses.matrix[20,])
plot(1:1000, num.losses.matrix[21,])
plot(1:1000, num.losses.matrix[22,])
plot(1:1000, num.losses.matrix[23,])
plot(1:1000, num.losses.matrix[24,])
plot(1:1000, num.losses.matrix[25,])
plot(1:1000, num.losses.matrix[26,])
plot(1:1000, num.losses.matrix[27,])
