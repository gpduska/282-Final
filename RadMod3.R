...
genetic.algorithm.3 <- function(population){
  ...
  loss.cutoff <- 9 #median(population[,7]) + 2
...
run.n.gens.3 <- function(n, population){
  ...
  for(i in 1:n){
    ...
    agent.8.encounter.slope <- append(agent.8.encounter.slope, population[8,7], after = length(agent.8.encounter.slope))
...
plot(1:5000, average.encounter.slope, xlab = "Selection Number", ylab = "M1" , main = "Average M1 After Selection Process")
plot(1:5000, average.encounter.intercept, xlab = "Selection Number", ylab = "B1" , main = "Average B1 After Selection Process")
plot(1:5000, average.take.attempt.slope, xlab = "Selection Number", ylab = "M2" , main = "Average M2 After Selection Process")
plot(1:5000, average.take.attempt.intercept, xlab = "Selection Number", ylab = "B2" , main = "Average B2 After Selection Process")
plot(1:5000, median.num.losses, xlab = "Selection Number", ylab = "Num Losses", main = "Median Number of Losses After Selection Process")

plot(1:5000, agent.1.encounter.slope)
par(new = TRUE)
plot(1:5000, agent.1.encounter.intercept, col = "green")
par(new = TRUE)
plot(1:5000, agent.1.take.attempt.slope, col = "blue")
par(new = TRUE)
plot(1:5000, agent.1.take.attempt.intercept, col = "red")
par(new = TRUE)
plot(1:5000, agent.1.num.losses)


plot(1:5000, num.losses.matrix[1,])
plot(1:5000, num.losses.matrix[2,])
plot(1:5000, num.losses.matrix[3,])
plot(1:5000, num.losses.matrix[4,])
plot(1:5000, num.losses.matrix[5,])
plot(1:5000, num.losses.matrix[6,])
plot(1:5000, num.losses.matrix[7,])
plot(1:5000, num.losses.matrix[8,])
plot(1:5000, num.losses.matrix[9,])
plot(1:5000, num.losses.matrix[10,])
plot(1:5000, num.losses.matrix[11,])
plot(1:5000, num.losses.matrix[12,])
plot(1:5000, num.losses.matrix[13,])
plot(1:5000, num.losses.matrix[14,])
plot(1:5000, num.losses.matrix[15,])
plot(1:5000, num.losses.matrix[16,])
plot(1:5000, num.losses.matrix[17,])
plot(1:5000, num.losses.matrix[18,])
plot(1:5000, num.losses.matrix[19,])
plot(1:5000, num.losses.matrix[20,])
plot(1:5000, num.losses.matrix[21,])
plot(1:5000, num.losses.matrix[22,])
plot(1:5000, num.losses.matrix[23,])
plot(1:5000, num.losses.matrix[24,])
plot(1:5000, num.losses.matrix[25,])
plot(1:5000, num.losses.matrix[26,])
plot(1:5000, num.losses.matrix[27,])
plot(1:5000, num.losses.matrix[28,])
plot(1:5000, num.losses.matrix[29,])
plot(1:5000, num.losses.matrix[30,])
...
qplot(1:1000, average.encounter.slope) +
